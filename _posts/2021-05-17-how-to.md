---
title: How to Contribute a new post
author: AToMiXhawK
date: 2021-05-17 20:00:00 +0530
categories: [Tutorial, Blogging]
tags: [contribute, post, blog, how, writing]
---

This blog is powered by [Jekyll](https://jekyllrb.com/), which is a simple
static site generator that generates webpages from markdown files. 
This post explains how to write and contribute a new post.
Please visit [Jekyll Docs](https://jekyllrb.com/docs/) to know more and maybe create a blog for yourself.

This blog uses [`jekyll-theme-chirpy`](https://github.com/cotes2020/jekyll-theme-chirpy) created by [cotes2020](https://github.com/cotes2020)

To contribute a new post either
- send the post as `.md` files under `_posts/` as a git patch or
- fork this repo, add your post and send a pull request.

Please refer [this post]({{ "/posts/text-and-typography/" | relative_url }}) and [markdownguide](https://www.markdownguide.org/basic-syntax/) to learn more about markdown syntax
